...
function About() {
  return (
    <div className="total flex">
      ...
      <p className='hachi text-xl text-center lg:text-left lg:ml-5 p-2'>KEKAWP AI is here to make sure you don`t miss any good snipes. You get pinged in time to setup and start winning</p>
